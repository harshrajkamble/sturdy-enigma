...
import { createTag } from '../../scripts/utilities.js';

const ARROW_NEXT_IMG = `<img class="next-icon" alt="Next icon" src="/blocks/carousel/img/arrow.svg" height="10" width="16">`;
const ARROW_PREVIOUS_IMG = `<img class="previous-icon" alt="Previous icon" src="/blocks/carousel/img/arrow.svg" height="10" width="16">`;
const LIGHTBOX_ICON = `<img class="expand-icon" alt="Expand carousel to full screen" src="/blocks/carousel/img/expand.svg" height="14" width="20">`;
const CLOSE_ICON = `<img class="expand-icon" alt="Expand carousel to full screen" src="/blocks/carousel/img/close.svg" height="20" width="20">`;
